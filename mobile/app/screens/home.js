...
export default function HomeScreen() {
  ...
  const sesionParaUI = sesionActiva && estadoActual !== 'sin_clase'
    ? {
    ...
    >
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              router.push({
                ...
                params: { asistencia_id: sesionActiva?.asistencia_id },
              })
            }
            activeOpacity={0.85}
          >
      ...
      {clasesHoy.length === 0 ? (
        <View style={s.emptyClases}>
          ...
          <BodyText muted style={{ marginTop: spacing[2], textAlign: 'center' }}>
...
const s = StyleSheet.create({
  ...
  loadingTxt:       { marginTop: spacing[3], fontSize: fontSizes.sm, color: colors.onSurfaceVariant },
  ...
  emptyClases:    { alignItems: 'center', paddingVertical: spacing[8], backgroundColor: colors.surfaceContainerLowest, borderRadius: radii.xl, marginBottom: spacing[4] },
